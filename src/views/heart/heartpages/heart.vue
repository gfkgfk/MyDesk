...
import * as SimplexNoise from './js/simplex-noise.js'
...
export default {
    created() {
        ...
        objLoader.setPath('/static/model/');// set path
        objLoader.load('heart_2.obj', obj => {
        ...
        // WEBPACK FOOTER //
        // src/views/heart/heartpages/js/script.js
    }
}
</script>
