"use strict";
export const init = function (cid) {

    Error.stackTraceLimit = Infinity;

    var $global, $module, $container;
    var containerId = cid
    if (typeof window !== "undefined") { /* web page */
        $global = window;
        $container = $global.document.getElementById(containerId)
    ...
    $packages["main"] = (function () {
        ...
        function rendercanvas () {
            ...
            $s = 0; var $f, $c = false;
            if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; _r$1 = $f._r$1; _tuple = $f._tuple; _tuple$1 = $f._tuple$1; cover = $f.cover; err = $f.err; rain1 = $f.rain1; rain2 = $f.rain2; $s = $f.$s; $r = $f.$r; }
            s: while (true) {
                switch ($s) {
                    case 0:
                        rain1 = [rain1];
        ...
        main = function () {
            ...
            //edit: add style sheet id; 
            sheet.id = 'cssmark'
            //edit: remove overflow:hidden; and annotate the header sheet style 
            ...
            //edit: fix render canvas function to make the component refresh after leave page
            rendercanvas()
        };
        itoa = function (i) {
            var i;
        ...
        DigitalRain.ptr.prototype.layout = function () {
            ...
            r.ratio = _tmp$2;
            if (!(r.canvas === null)) {
                //edit:change the parent container
                $container.removeChild(r.canvas);
